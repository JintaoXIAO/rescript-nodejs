...
@module("path") external format: path => string = "format"
...
@module("path") external parse: string => path = "parse"
...
module Posix = {
  ...
  @module("path") @scope("posix")
  external format: path => string = "format"
  ...
  @module("path") @scope("posix")
  external parse: string => path = "parse"
